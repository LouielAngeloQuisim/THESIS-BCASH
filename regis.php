                    ...
                    <div class="box shadow bg-white p-4">
                        ...
                        <form action="" class="mb-3">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control rounded-1" id="lastname" placeholder="Enter Last Name">
                                <label for="lastname" required>Last Name</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control rounded-1" id="firstname" placeholder="Enter First Name">
                                <label for="firstname" required>First Name</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control rounded-1" id="middlename" placeholder="Enter Middle Name">
                                <label for="middletname" required>Middle Name</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control rounded-1" id="email" placeholder="Enter Email">
                                <label for="email" required>Email</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="tel" class="form-control rounded-1" id="num" placeholder="Enter Mobile Number">
                                <label for="num" required>Mobile Number</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control rounded-1" id="username" placeholder="Enter Username">
                            ...
                            -->
                            <div class="form-floating mb-3">
                                <input type="password" class="form-control rounded-1" id="password" placeholder="Enter Password">
                            ...
                            <div class="d-grid gap-2 mb-3">
                                <button type="submit" class="btn btn-dark btn-lg btn-block border-0 rounded-0">
                                    Sign up
                                </button>
                            </div>
