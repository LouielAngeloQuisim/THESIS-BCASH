  ...
  <body>
                            ...
                            <li class="page-item">
                                <?php
                                    if(isset($page)){
                                        if($page < 1){
                                            $page = $page - 1;
                                            echo '<a class="page-link" href="transac_admin_redeem.php?page='.$page.'" aria-label="Previous">';
                                        }
                                        else{
                                            echo '<a class="page-link" href="transac_admin_redeem.php?page='.$page.'" aria-label="Previous">';
                                        }
                                ...
                                <li class="page-item">
                                    <?php
                                        if(isset($page)){
                                            if($page < 1){
                                                $page = $page + 1;
                                                echo '<a class="page-link" href="transac_admin_redeem.php?page='.$page.'" aria-label="Next">';
                                            }
                                            else{
                                                echo '<a class="page-link" href="transac_admin_redeem.php?page='.$page.'" aria-label="Next">';
                                            }
    ...
    <div class="modal fade modalpopup" id="modalgenRepRedeem" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalgenRepRedeem">Generate Redeem Reports</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    Filter by:
