...
(9, 36, 'COKE_290ML', 2, 10, '2022-01-11 17:55:22', 1),
(10, 36, 'COKE_290ML', 2, 10, '2022-01-11 20:25:00', 1);
...
('louielxxxx', 57, '1234', '', 0, 0, 'quisim', 'louiel ', 'coyoca', 'tatalipot@gmail.com', 9080808080, 0);
...
--
ALTER TABLE `bottle_types`
  MODIFY `bottle_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `recycle_transaction`
  MODIFY `trans_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `user_login`
  MODIFY `acc_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
