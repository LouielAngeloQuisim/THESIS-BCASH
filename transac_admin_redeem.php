...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3">
        <div class="container">
            <a href="transac_admin_redeem.php" class="navbar-brand fw-bold">BCASH</a>
            ...
            <div class="card text-center">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs">
                        <li class="nav-item">
                            <a class="nav-link" href="transac_admin_recycle.php">Recycle Tab</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="transac_admin_redeem.php">Redeem Tab</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="row row-cols-1 row-cols-md-2 text-center">
                        <div class="col text-start py-3">
                            ...
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label ms-2" for="mnameswitch">
                                    Generate All
                                </label>
                            </div>
    ...
    <div class="modal fade modalpopup" id="modalgenRedConfirm" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="lead">
                        Are you sure to Generate this Redeem Report?
                    </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
