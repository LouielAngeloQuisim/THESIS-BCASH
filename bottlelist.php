        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" step="any" class="form-control rounded-1" id="bcurrency" onkeyup='add_bottles();'  placeholder="Enter Bottle Price" name="bcurrency" required>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="number" step="any" class="form-control rounded-1" id="ebcurrency'.$bid.'" onkeyup="'.$edit_bottles.'();" placeholder="Enter Bottle Price" name="bcurrency"
                                     required>
